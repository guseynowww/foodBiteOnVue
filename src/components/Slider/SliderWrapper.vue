    ...
    <div class="slider">
        ...
        <div class="slider__img">
            <div class="slider__counter">
                <img @click="prevSlide" style="cursor: pointer;" src="@/assets/img/slider/left.svg" alt="left-arrow.svg">
                <span class="current">0{{ currentSlideIndex + 1 }}</span>
                <span class="total">/04</span>
                <img @click="nextSlide" style="cursor: pointer;" src="@/assets/img/slider/right.svg" alt="right-arrow.svg">
            </div>
